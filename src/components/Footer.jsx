...
export default function Footer({
    ...
    return (
        <>
            <div className="fixed bottom-0 flex justify-between items-center w-full h-[3.2rem] bg-neutral-800 bg-opacity-60 backdrop-blur-lg border-t-[0.2px] border-neutral-700 select-none pointer-events-auto py-[0.2rem] text-white z-40">
